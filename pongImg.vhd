...
-- velocity --
	...
	constant ball_vel_y_n : integer := -3; --top y
	constant ball_vel_y_p : integer := 3;	--down y
	constant ball_vel_x_n : integer := -3; --left
	constant ball_vel_x_p : integer := 3;	--right
...
-- signals for creating image --
	...
	signal ball_team : integer range 2 downto 0 := 0; --who touched ball last
	signal background_red, background_green, background_blue : std_logic_vector(9 downto 0);
	signal line_red, line_green, line_blue : std_logic_vector(9 downto 0); --color of line
...
begin
	...
	framerate <= refresh; --get signal for refresh
